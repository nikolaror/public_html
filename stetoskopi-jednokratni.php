...
$crumb1="portfolio";
$crumb1url="portfolio";
$crumb3="HSO STETOSKOP jednokratni";
?>
<html class="no-js">
<head>
	...
	<?php include 'template/h.php';?><!--header-->
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div id="page-header">
                ...
                <div class="row">
                	<div class="span12">
                    <h2><a href="<?php echo $crumb1url.'.php';?>"><?php echo $crumb1;?></a> / <a href="<?php echo $category.'.php';?>"><?php echo $category;?></a> / <?php echo $crumb3;?></h2>	
            ...
            <div class="row">
            	<div class="span6">
					...
					<div id = "imagecontainer">
						...
						<div class="preview" align="center">
							<img name="preview"  src="_content/portfolio/stetoskop1.png" alt=""/>
						</div>
						<div class="thumbnails">
							<img onmouseover="preview.src=img1.src" name="img1" src="_content/portfolio/stetoskop1.png" alt="" />
							<img onmouseover="preview.src=img2.src" name="img2" src="_content/portfolio/stetoskop2.png" alt="" />
							<img onmouseover="preview.src=img3.src" name="img3" src="_content/portfolio/stetoskop3.png" alt="" />
							<img onmouseover="preview.src=img4.src" name="img4" src="_content/portfolio/stetoskop4.png" alt="" />
						</div>
                ...
                <div class="span6">
                	...
                	<div class="icon-box-1">
                            ...
                            <h2>HSO STETOSKOP jednokratni</h2>
                    </div><!-- end .icon-box-1 -->
                    <ul class="circle">
						<li>bezbedni sa higijenske strane zbog jednokratne upotrebe</li>
						<li>napravljen od izuzetno lagane akrilne smole</li>
						<li>netoksični materijali</li>
						<li>ekstremno osetljiva membrane  za odličnu čujnost</li>
						<li>bez latexa</li>
                    </ul>
            ...
            <div class="row">
                        ...
                        <div class="icon-box-content">
                            ...
                            <p>Preuzmite kompletan katalog <a href="_content/pfd-katalog/HSO_stetoskopi.pdf" download="_content/pfd-katalog/HSO_stetoskopi.pdf">ovde</a></p>
