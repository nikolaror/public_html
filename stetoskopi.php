...
$companyName="Heintel";
$crumb1="portfolio";
$crumb1url="portfolio.php";

$product1="HSO Stetoskop dvostrani";
$product1url="stetoskopi-dvostrani.php";
$product2="HSO Stetoskop za sestre Schwestern";
$product2url="stetoskopi-za-sestre.php";
$product3="HSO Stetoskop jednokratni";
$product3url="stetoskopi-jednokratni.php";
?>
<html class="no-js">
<head>
