...
$crumb1="portfolio";
$crumb1url="portfolio";
$category="nožići i skalpeli";

$product1="STANDARDNI NOŽIĆI od N° 18 do N° 36";
$product1url="seciva-skalpel-18-36.php";
$product2="STANDARDNI NOŽIĆI od N° 10 do N° 15";
$product2url="seciva-skalpel-10-15.php";
$product3="HERKULES nožići";
$product3url="seciva-hercules.php";
$product4="HSO SKALPELI";
$product4url="seciva-skalpel.php";
$product5="SAFETY SKALPELI";
$product5url="seciva-skalpel-safety-skalpeli.php";
$product6="ZEUS BEZBEDNOSNI SKALPEL DRŽAČI";
$product6url="seciva-zeus-drzac.php";
?>
<html class="no-js">
<head>
            ...
            <div class="row">
            	<div class="span4">
                    ...
                    <div class="team-member">
                        ...
                        <img src="_content/portfolio/nozici2.png" alt="">
...
<h2>HSO Nožići i skalpeli</h2>
<h2>Najoštrije instrumente možete nabaviti samo u Heintel-u!</h2>
                            
                            <p>developed by <strong>HSO</strong></p>
                    ...
                    <ul class="circle">
                        ...
                        <div class="icon-box-content">
                            ...
                            <p>Preuzmite kompletan katalog <a href="_content/pfd-katalog/HSO_skalpeli_i_nozici.pdf" download="_content/pfd-katalog/HSO_skalpeli_i_nozici.pdf">ovde</a></p>
