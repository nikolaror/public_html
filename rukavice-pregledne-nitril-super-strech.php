...
$pageName="Rukavice"; 
$menuItem="rukavice"; 
$product="pregledne-nitril-super-strech";
$companyName="Heintel";
$crumb1="portfolio";
$crumb1url="portfolio";
$productName="Pregledne HSO NITRIL SUPER STRETCH";
$category="Rukavice";
?>
<html class="no-js">
<head>
            ...
            <div class="row">
                ...
                <div class="span6">
                	...
                	<div class="icon-box-1">
                            ...
                            <h2>HSO NITRIL SUPER STRETCH - NITRIL-RUKAVICE PUDERFEE / NESTERILNE</h2>
                    </div><!-- end .icon-box-1 -->
<p>HSO Nitril super stretch rukavice su potpuno istih osobina kao HSO Nitril rukavice, samo je boja ljubičasta i 200 komada je u komercijalnom pakovanju radi ekonomičnosti.</p>
