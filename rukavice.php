...
$product1="HSO Crystal";
$product1url="rukavice-hirurske-crystal.php";
$product2="HSO Comfort grip";
$product2url="rukavice-hirurske-comfort.php";
$product3="HSO Synth";
$product3url="rukavice-hirurske-synth.php";
$product4="HSO Premium";
$product4url="rukavice-pregledne-premium.php";
$product5="HSO Nitril";
$product5url="rukavice-pregledne-nitril.php";
$product6="HSO Nitril Strech";
$product6url="rukavice-pregledne-nitril-strech.php";
$product7="HSO Nitril Super Strech";
$product7url="rukavice-pregledne-nitril-super-strech.php";
$product8="HSO Vinyl";
$product8url="rukavice-pregledne-vinyl.php";
?>
<html class="no-js">
<head>
            ...
            <div class="row">
            	<div class="span4">
                    ...
                    <div class="team-member">
                        ...
                        <img src="_content/portfolio/rukavice5.png" alt="">
                        
                        <br class="clear">
            <h2>Proizvodi</h2>            
							
                            <h4>Rukavice hirurške</h4><br/>
                            <a href="<?php echo $product1url;?>" >
                            	<i><?php echo $product1;?></i>
                            </a>
							<br/>
							<a href="<?php echo $product2url;?>" >
                            	<i><?php echo $product2;?></i>
                            </a><br/>   
							<a href="<?php echo $product3url;?>" >
                            	<i><?php echo $product3;?></i>
                            </a><br/> <br/>  
							
                            <h4>Rukavice pregledne</h4><br/>
                            <a href="<?php echo $product4url;?>" >
                            	<i><?php echo $product4;?></i>
                            </a>
							<br/>
							<a href="<?php echo $product5url;?>" >
                            	<i><?php echo $product5;?></i>
                            </a><br/>   
							<a href="<?php echo $product6url;?>" >
                            	<i><?php echo $product6;?></i>
                            </a><br/> 
							<a href="<?php echo $product7url;?>" >
                            	<i><?php echo $product7;?></i>
                            </a>
							<br/>
							<a href="<?php echo $product8url;?>" >
                            	<i><?php echo $product8;?></i>
                            </a><br/>             
                    </div><!-- end .team-member -->
...
<h2>HSO HIRURŠKE RUKAVICE</h2>

<p>Sa latex-om ili bez, sigurnost je zagarantovana sa HSO</p>

<p>Sve HSO hirurške rukavice, sa latex-om ili bez, rezultat su dugogodišnjeg iskustva, proučavanja i odličnog poznavanja materijala. Sve rukavice prolaze rigoriznu kontrolu kvaliteta i sterilnosti u toku procesa proizvodnje</p>

<p>HSO hirurške rukavice su posebno dizajnirane da prate anatomiju šake. Zakrivljene su u predelu prstiju, tako da idealno prijanjaju i izgledaju kao druga koža</p>
