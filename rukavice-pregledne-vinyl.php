...
$pageName="Rukavice"; 
$menuItem="rukavice"; 
$product="pregledne-vinyl";
$companyName="Heintel";
$crumb1="portfolio";
$crumb1url="portfolio";
$productName="pregledne HSO VINYL";
$category="Rukavice";
?>
<html class="no-js">
<head>
            ...
            <div class="row">
                ...
                <div class="span6">
                	...
                	<div class="icon-box-1">
                            ...
                            <h2>HSO VINYL - VINYL-RUKAVICE PUDERFREE / NESTERILNE</h2>
                    </div><!-- end .icon-box-1 -->
<p>HSO vinyl rukavice imaju glatku i veoma prijatnu površinu. Veoma je korisna alternativa za korišćenje na terenu. Pored toga, sprečava nastanak latex alergija.</p> 
