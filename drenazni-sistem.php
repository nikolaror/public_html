...
$crumb1="portfolio";
$crumb1url="portfolio";
$crumb3="Urin drenažni zatvoreni sistem";
?>
<html class="no-js">
<head>
            ...
            <div class="row">
            	<div class="span4">
                    ...
                    <div class="team-member">
                        ...
                        <br class="clear">
            <h2>Proizvodi</h2>            
								<a href="<?php echo $menuItem.'-'.$product1inCat.'.php';?>" >
                            	<i>HSO H6 plus urin kesa</i>
                            </a>
				...
				<h2>Karkteristike HSO Urin drenažno-zatvorenog sistema</h2>
                <p>Da bi se rizik od bolničkih infekcija sveo na najmanju moguću meru, HSO nudi zatvoreni, sterilni
 urin drenažni sistem H6 plus.</p>
<p>HSO urin kesa H6 plus je jednostavna za korišćenje i odgovara uobičajenim standardima. Prilagođena je svim korisnicima i veoma jednostavna za rukovanje. Fiksaciju creva dodatno potpomaže plavi nastavak, a plavi ventil na ispustu  pomera se levo-desno čime je lagano omogućeno  pražnjenje urin kese. Takođe, moguće je uzorkovanje urina iz konektora za kateter bez upotrebe igle. Ceo konektor za kateter se veoma lako čisti čime se održava higijena i produžava rok trajanja kese, što ima veliki i ekonomski značaj.</p>
<p>HSO urin kesa H6 plus ima zapreminu od 2.000 ml i mogućnost fiksacije bilo gde (bolesnički krevet, stalak…). Providna komora sa okapnicom ima membranu koja onemogućava bakterijama retrogradnu migraciju čime se smanjuje rizik od infekcija. Celokupan dizajn komore sa okapnicom sprečava i vraćanje urina u kateter. Crevo je savitljivo i bezbedno.</p><p>Dostupne su dve verzije H6 plus urin kesa: sa tvrdim i mekim crevom.</p>
