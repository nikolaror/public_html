...
$crumb1="portfolio";
$crumb1url="portfolio";
$productName=" MASKA SA LASTIŠEM ili POVESKAMA";
?>
<html class="no-js">
<head>
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="row">
            	<div class="span6">
					...
					<div id = "imagecontainer">
						...
						<div class="preview" align="center">
							<img name="preview"  src="_content/portfolio/maska1.png" alt=""/>
						</div>
						<div class="thumbnails">
							<img onmouseover="preview.src=img1.src" name="img1" src="_content/portfolio/maska1.png" alt="" />
							<img onmouseover="preview.src=img2.src" name="img2" src="_content/portfolio/maska2.png" alt="" />
							<img onmouseover="preview.src=img3.src" name="img3" src="_content/portfolio/maska3.png" alt="" />
							<img onmouseover="preview.src=img4.src" name="img4" src="_content/portfolio/maska4.png" alt="" />
							<img onmouseover="preview.src=img5.src" name="img5" src="_content/portfolio/maska5.png" alt="" />
						</div>
                ...
                <div class="span6">
                	...
                	<div class="icon-box-1">
							...
							<h2>MASKA SA LASTIŠEM ili POVESKAMA/ NESTERILNA</h2>
                    </div><!-- end .icon-box-1 -->

                    
                    <ul class="circle">
                    	<li>HSO zaštitna troslojna maska sa lastišem, veoma prijatna za kožu i sa visokim stepenom zaštite od infekcija</li>
                        <li>lagana pertla ili ekstra meki lastiš oko uha</li>
						<li>fleksibilne preko nosa</li>
						<li>Latex- i fiberglas free</li>
                        <li>99 % efikasnost filtrecije (BFE)</li>
                        <li>Pored toga maska je modelirana tako da preko nosa osigurava udobno nošenje</li>
						<li>50 komada u pakovanju</li>
                    </ul>
            ...
            <div class="row">
                        ...
                        <div class="icon-box-content">
                            ...
                            <p>Preuzmite kompletan katalog <a href="_content/pfd-katalog/HSO_hirurska_maska_KS7.pdf"  download="_content/pfd-katalog/HSO_hirurska_maska_KS7.pdf">ovde</a></p>
