...
$companyName="Heintel";
$crumb1="portfolio";
$crumb2="nožići i skalpeli";
$crumb1url="portfolio";
$crumb2url="seciva";
$crumb3="ZEUS BEZBEDNOSNI SKALPEL DRŽAČI";
?>
<html class="no-js">
<head>
	...
	<?php include 'template/h.php';?><!--header-->
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div id="page-header">
                ...
                <div class="row">
                	<div class="span12">
                        <h2><a href="<?php echo $crumb1url.'.php';?>"><?php echo $crumb1;?></a> / <a href="<?php echo $crumb2url.'.php';?>"><?php echo $crumb2;?></a> / <?php echo $crumb3;?></h2>
                    </div><!-- end .span12 -->
                </div><!-- end .row -->
