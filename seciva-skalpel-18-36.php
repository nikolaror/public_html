...
$pageName="Seciva"; 
$menuItem="seciva"; 
$product="skalpel-18-36";
$companyName="Heintel";
$crumb1="portfolio";
$crumb1url="portfolio";
$productName="STANDARDNI NOŽIĆI od N° 18 do N° 36";
	...
	<?php include 'template/h.php';?><!--header-->
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div id="page-header">
                ...
                <div class="row">
                	<div class="span12">
                    	<h2><a href="<?php echo $crumb1url.'.php';?>"><?php echo $crumb1;?></a> / <a href="<?php echo $menuItem.'.php';?>"><?php echo $category;?></a> / <?php echo $productName;?></h2>
                    </div><!-- end .span12 -->
                </div><!-- end .row -->
            ...
            <div class="row">
            	<div class="span6">
					...
					<div id = "imagecontainer">
						...
						<div class="preview" align="center">
							<img name="preview" src="_content/portfolio/nozici1.png" alt=""/>
						</div>
						<div class="thumbnails">
							<img onmouseover="preview.src=img1.src" name="img1" src="_content/portfolio/nozici1.png" alt="" />
							<img onmouseover="preview.src=img2.src" name="img2" src="_content/portfolio/nozici2.png" alt="" />
							<img onmouseover="preview.src=img4.src" name="img4" src="_content/portfolio/nozici3.png" alt="" />
						</div>
                ...
                <div class="span6">
                	...
                	<div class="icon-box-1">                        
                            <h2>STANDARDNI NOŽIĆI od N° 18 do N° 36</h2>
                            <p>Noževi su napravljeni od Carbon čelika i odgovaraju ručkama/držačima N°4</p>
