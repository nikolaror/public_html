<!DOCTYPE html>
<?php
$pageName="Drenazni sistem"; 
$category="Urin drenažni zatvoreni sistem"; 
$menuItem="drenazni-sistem"; 
$product="ukesa";
$companyName="Heintel";
$crumb1="portfolio";
$crumb1url="portfolio";
$productName="HSO H6 plus urin kesa";
$crumb2="Urin drenažni zatvoreni sistem";
$crumb2url="drenazni-sistem";
?>
<html class="no-js">
<head>
	...
	<?php include 'template/h.php';?><!--header-->
		...
		<!-- /// CONTENT  /////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            ...
            <div id="page-header">
                ...
                <div class="row">
                	<div class="span12">
                    	<h2><a href="<?php echo $crumb1url.'.php';?>"><?php echo $crumb1;?></a> / <a href="<?php echo $crumb2url.'.php';?>"><?php echo $crumb2;?></a> / <?php echo $productName;?></h2>
            ...
            <div class="row">
            	<div class="span6">
					...
					<div id = "imagecontainer">
						...
						<div class="preview" align="center">
							<img name="preview"  src="_content/portfolio/ukesa1.png" alt=""/>
						</div>
						<div class="thumbnails">
							<img onmouseover="preview.src=img1.src" name="img1" src="_content/portfolio/ukesa1.png" alt="" />
							<img onmouseover="preview.src=img2.src" name="img2" src="_content/portfolio/ukesa2.png" alt="" />
							<img onmouseover="preview.src=img3.src" name="img3" src="_content/portfolio/ukesa3.png" alt="" />
                ...
                <div class="span6">
                	...
                	<div class="icon-box-1">
                            ...
                            <h2>HSO H6 plus urin kesa</h2>
                    </div><!-- end .icon-box-1 -->

<p>HSO H6 plus urin drenažni sistem nije ja višekratnu upotrebu i može da se koristi maksimalno šest dana.</p>
				                    <ul class="circle">
<li>Uzorkovanje bez igle</li>
<li>Membrana na komori sprečava retrogradno vraćanje bakterija</li>
<li>Jednostavan ispusni ventil</li>
<li>revo dužine do 120cm koje se lako fiksira</li>
<li>Moguća fikasacija urin kese bilo gde </li>
<li>Zaprmina 2.000ml</li>
<li>Latex free</li>
                    </ul>
                </div><!-- end .span6 -->
            </div><!-- end .row -->
<!--tab-->
            <div class="row">
                        ...
                        <div class="icon-box-content">
                            ...
                            <p>Preuzmite kompletan katalog <a href="_content/pfd-katalog/HSO_urin_kesa_H6.pdf" download="_content/pfd-katalog/HSO_urin_kesa_H6.pdf">ovde</a></p>
