				...
				<h2>Infuzija</h2>   
                	<div id="tab-1">
                        <ul class="tabs-menu fixed">
                            <li>
                                <a href="#content-tab-1-1">&nbsp;</br>HSO FLOW P</a>
                            </li>
                            <li>
                                <a href="#content-tab-1-2">&nbsp;</br>HSO BLOOD</a>
                            </li>
                            <li>
                                <a href="#content-tab-1-3">HSO SIGURNOSNI ČEP/</br>meko pakovanje</a>
                            </li>
                        </ul><!-- end .tabs-menu -->
                    ...
                    <ul class="circle">
						<li>infuzioni set</li>
						<li>oranž klema</li>
						<li>Gamma sterilisano</li>
						<li>testiran na pritisak</li>
						<li>otporan na kontaminaciju bakterijama</li>
						<li>sistem ventilacije</li>
						<li>dužina od 160cm</li>
						<li>pakovanje od 100 komada</li>
                    </ul>
                    ...
                    <ul class="circle">
						<li>set za transfuziju</li>
						<li>filter (200μ)</li>
						<li>pokretna roll klema</li>
						<li>Gamma sterilisano</li>
						<li>u pakovanju 50 kom</li>
                    </ul>          
                            </div>
