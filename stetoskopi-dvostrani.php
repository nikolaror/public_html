...
$crumb1="portfolio";
$crumb1url="portfolio";
$crumb3="HSO STETOSKOP dvostrani";
?>
<html class="no-js">
<head>
            ...
            <div class="row">
                ...
                <div class="span6">
                	...
                	<div class="icon-box-1">
                            ...
                            <h2>HSO STETOSKOP dvostrani</h2>
                    </div><!-- end .icon-box-1 -->
                    <ul class="circle">
						<li>dupla glava</li>
						<li>držač je od laganog aluminijuma u boji</li>
						<li>posebna membrane povećava i do 50% čujnost u odnosu na konvencionalne stetoskope</li>
						<li>podesiva kuka za uho</li>
						<li>crevo bez latexa</li>
                    </ul>
