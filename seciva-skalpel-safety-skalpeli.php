...
$pageName="Seciva"; 
$menuItem="seciva"; 
$product="safety-skalpel";
$companyName="Heintel";
$crumb1="portfolio";
$crumb1url="portfolio";
$category="nožići i skalpeli";
$productName="SAFETY SKALPELI";  
?>
<html class="no-js">
<head>
            ...
            <div class="row">
                ...
                <div class="span6">
                	...
                	<div class="icon-box-1">                        
                            <h2>SAFETY SKALPELII</h2>
                            <p>HSO SAFETY-Skalpeli  su opremljeni dodatnim uvlačećim pokolpcem čime se povećava bezbednost pri rukovanju</p>
